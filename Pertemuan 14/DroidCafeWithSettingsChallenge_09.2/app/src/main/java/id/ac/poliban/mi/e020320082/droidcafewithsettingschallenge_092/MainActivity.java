...
package id.ac.poliban.mi.e020320082.droidcafewithsettingschallenge_092;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.e020320082.droidcafewithsettingschallenge_092.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe_zaey");
