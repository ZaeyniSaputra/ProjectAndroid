package id.ac.poliban.mi.e020320082.hellosharedprefs_091;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.e020320082.hellosharedprefs_091";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("HelloSharedPrefs_zaey");
